---
name: repomix-reference-discord-bot-template
description: Reference codebase for Discord Bot Template. Use this skill when you need to understand the structure, implementation patterns, or code details of the Discord Bot Template project.
---

# Discord Bot Template Codebase Reference

1 files | 2 lines | 57 tokens
